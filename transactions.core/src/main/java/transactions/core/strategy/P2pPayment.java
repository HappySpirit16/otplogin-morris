...
public class P2pPayment implements IPaymentsMethod {
	...
	public String createCredit(Credit credit,GeneralInformation generalInformation, Context context,DynamoDBMapper mapper) {
		...
		double installmentFeeCharge=Double.parseDouble(credit.getCoverageFGAValue());
		...
		loan.setConfigId("approbe_loan_config_p2p_v1");
		loan.setDailyFeeCharge((int)result);
		...
		credit.setConfigId("approbe_loan_config_p2p_v1");
