...
public class BnplImpl implements IBnpl {
	...
	public String saveTransaction(Request request, DynamoDBMapper mapper, AmazonDynamoDB db, Context context, String configId) {
		...
		context.getLogger().log("actualiza credito: " );
		...
		context.getLogger().log("retorna string: " + body);
		return body;
	}
