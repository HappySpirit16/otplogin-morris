...
public class Request {
	...
	public String toString() {
		return "{\"creditId\":\"" + creditId + "\", \"id\":\"" + id + "\", \"numberIdBorrower\":\"" + numberIdBorrower
				+ "\", \"numberIdMoneylender\":\"" + numberIdMoneylender + "\", \"entityCode\":\"" + entityCode
				+ "\", \"acountBankPartner\":\"" + acountBankPartner + "\", \"dateSaveBD\":\"" + dateSaveBD
				+ "\", \"fechaAprobacion\":\"" + fechaAprobacion + "\", \"lastPaymentDate\":\"" + lastPaymentDate
				+ "\", \"nameBorrower\":\"" + nameBorrower + "\", \"ranking\":\"" + ranking + "\", \"active\":\""
				+ active + "\", \"gender\":\"" + gender + "\", \"activityBorrower\":\"" + activityBorrower
				+ "\", \"warranty\":\"" + warranty + "\", \"plannerPay\":\"" + plannerPay + "\", \"saldoCredito\":\""
				+ saldoCredito + "\", \"approveValue\":\"" + approveValue + "\", \"rateApprobe\":\"" + rateApprobe
				...
				+ "\", \"statusDate\":\"" + statusDate + "\", \"ammount\":\"" + ammount + "\", \"status\":\"" + status
				+ "\", \"cycle\":\"" + cycle + "\", \"accountingDate\":\"" + accountingDate + "\", \"client\":\""
				+ client + "\", \"partial\":\"" + partial + "\", \"accountId\":\"" + accountId + "\"}";
	}
