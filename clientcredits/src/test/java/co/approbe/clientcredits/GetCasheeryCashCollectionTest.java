...
import co.approbe.core.TestContext;

public class GetCasheeryCashCollectionTest {
	...
	public void testLambdaFunctionHandler() {
		...
		//List<CashPayment> wLst = wBackOfficeService.getCasheerCashPayments(wDateFilterDto,ctx);
