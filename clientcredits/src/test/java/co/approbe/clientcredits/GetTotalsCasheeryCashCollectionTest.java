...
public class GetTotalsCasheeryCashCollectionTest {
	...
	public void testLambdaFunctionHandler() {
		...
		DateFilterDto wDateFilterDto = new DateFilterDto("20240608", "20240610", "80123123", 0, 50);
		...
		//BackOfficeService wBackOfficeService = new BackOfficeService(db, ctx);
		
		//List<DateFilterDto> wLst = wBackOfficeService.getTotalsCasheerCashPayments(wDateFilterDto,ctx);

		//ctx.getLogger().log("Cantidad de dias recibidos: "+wLst.size());
