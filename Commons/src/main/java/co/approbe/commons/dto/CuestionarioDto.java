...
public class CuestionarioDto {
	...
	public String toString() {
		return "{\"cuestionario\":\"" + cuestionario + "\", \"registroCuestionario\":\"" + registroCuestionario
				+ "\", \"fecha\":\"" + fecha + "\", \"cliente\":" + cliente.toString() + ", \"rtaCuestionario\":"
				+ rtaCuestionario.toString() + ", \"preguntas\":" + preguntas.toString() + "}";
	}
