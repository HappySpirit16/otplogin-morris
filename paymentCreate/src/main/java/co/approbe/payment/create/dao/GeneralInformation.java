...
public class GeneralInformation {
	...
	public double getPorcentajeComisionAdmi() {
		return porcentajeComisionAdmi;
	}
	public void setPorcentajeComisionAdmi(double porcentajeComisionAdmi) {
		this.porcentajeComisionAdmi = porcentajeComisionAdmi;
	}
	@Override
	public String toString() {
		return "{\"id\":\"" + id + "\", \"coverageFGAPercentage\":\"" + coverageFGAPercentage
				...
				+ "\", \"porcentajeComisionAdmi\":\"" + porcentajeComisionAdmi + "\"}";
	}
}
