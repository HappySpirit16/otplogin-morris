...
//		canonicalUrl.append(path).append("\n").append("\n");
		...
		System.out.println("canonical "+canonicalUrl.toString());
...
//	String val="POST\n"+path+"\n\nhost:prep.powwi.co\nx-amz-date:"+getTimeStamp()+"\n\nhost;x-amz-date\n"+payloadHex+"";
	...
	private String calculateSignature(String stringToSign) {
		try {
			...
			//byte[] signatureKey = getSignatureKey("wJalrXUtnFEMI/K7MDENG+bPxRfiCYEXAMPLEKEY", "20120215", "us-east-1", "iam");
//			System.out.println("awsSecretKey "+awsSecretKey+" currentDate "+currentDate+" region "+region+" service "+service);
	...
	private String buildAuthorizationString(String signature) {
		return hmacAlgorithm + " " + "Credential=" + awsAccessKey + "/" + getDate() + "/" + region + "/" + service + "/"
				+ aws4Request + "," + "SignedHeaders=" + signedHeaders + "," + "Signature=" + signature;
	}
